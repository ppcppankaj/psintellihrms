...
class CustomTokenObtainPairSerializer(TokenObtainPairSerializer):
    ...
    def get_token(cls, user):
        ...
        # 🔒 SECURITY: Freeze role context (even if ABAC is used)
    ...
    def validate(self, attrs):
        ...
        # 🔒 SECURITY: Token creation already enforces org binding
...
class UserOrgAdminCreateSerializer(serializers.ModelSerializer):
    """
    🔒 SECURITY: Org admins create users ONLY inside their org
    """
