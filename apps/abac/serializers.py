...
class AttributeTypeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AttributeType
        fields = [
            'id', 'name', 'code', 'category', 'data_type', 
...
class PolicyRuleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PolicyRule
        fields = [
            'id', 'attribute_type', 'attribute_type_name', 'attribute_path',
...
class PolicySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Policy
        fields = [
            'id', 'name', 'code', 'description', 'policy_type', 'effect',
...
class UserPolicySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserPolicy
        fields = [
            'id', 'user', 'user_email', 'policy', 'policy_name', 'policy_code',
...
class GroupPolicySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = GroupPolicy
        fields = [
            'id', 'name', 'group_type', 'group_value', 'policies',
...
class PolicyLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PolicyLog
        fields = [
            'id', 'user', 'user_email', 'policy', 'policy_name',
...
class PermissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Permission
        fields = [
            'id', 'name', 'code', 'description', 'module', 'action', 'permission_type'
        ]
        read_only_fields = ['id']
