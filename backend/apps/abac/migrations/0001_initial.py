    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "permission_type",
                    models.CharField(db_index=True, default="module", max_length=50),
                ),
                (
                    "created_by",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("and", "AND - All rules must match"),
                            ("or", "OR - Any rule can match"),
                        ],
                        default="and",
                        max_length=10,
                    ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="legacy_roles", to="abac.policy"
                    ),
                ),
                (
                    "updated_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "policies",
                    models.ManyToManyField(
                        related_name="group_assignments", to="abac.policy"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "-evaluated_at"],
                        name="abac_policy_user_id_1a1394_idx",
                    ),
                    models.Index(
                        fields=["resource_type", "action", "-evaluated_at"],
                        name="abac_policy_resourc_a07999_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="abac_roleas_user_id_c0a334_idx",
                    ),
                    models.Index(
                        fields=["role", "is_active"],
                        name="abac_roleas_role_id_fd3cfd_idx",
                    ),
                ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="policies_assigned",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="legacy_role_assignments",
                        to="abac.role",
                    ),
                ),
                (
