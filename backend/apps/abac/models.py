...
class AttributeType(EnterpriseModel):
    """
...
class PolicyRule(EnterpriseModel):
    """
...
class UserPolicy(EnterpriseModel):
    """
...
class GroupPolicy(EnterpriseModel):
    """
...
class PolicyLog(EnterpriseModel):
    """
...
class RoleAssignment(EnterpriseModel):
    """
...
class UserRole(EnterpriseModel):
    """
...
class Permission(EnterpriseModel):
...
class RolePermission(EnterpriseModel):
