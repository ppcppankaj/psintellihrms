...
class LeaveBalanceService:
    ...
    @classmethod
    @transaction.atomic
    def run_monthly_accrual(cls, tenant = None):
        """
    ...
    @classmethod
    @transaction.atomic
    def run_year_end_carryforward(cls, from_year: int, to_year: int):
        """
...
class LeaveApprovalService:
    ...
    @classmethod
    def get_pending_approvals(cls, approver):
    ...
    @classmethod
    def get_team_leaves(cls, manager, start_date: date = None, end_date: date = None):
